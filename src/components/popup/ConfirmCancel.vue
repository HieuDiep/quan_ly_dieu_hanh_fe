  ...
  <v-dialog v-model="isVisible" persistent max-width="520px">
    <v-card>
      <v-card-title class="header py-5">
        <p class="mb-0">Do you really want to Cancel?</p>
      </v-card-title>
      <v-card-actions class="p-4 pt-0 d-flex justify-center">
        <v-btn text @click="cancel" class="cancel white--text" > Cancel </v-btn>
        <v-btn text @click="confirm" class="yes white--text ml-4"> Yes </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
